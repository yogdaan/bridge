...
### Running yogi Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start yogi locally by running:
...
Then you can interact with yogi by typing `yogi help`.

    yogi> yogi help
    yogi animate me <query> - The same thing as `image me`, except adds [snip]
    yogi help - Displays all of the help commands that yogi knows about.
    ...
